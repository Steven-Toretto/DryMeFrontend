                      ...
                      <div className="mb-5 bg-blue-50/40 rounded-2xl p-4">
                        ...
                        <div className="space-y-2 text-sm">
                          ...
                          <div className="flex justify-between items-center">
                            ...
                            <span className={paymentCfg.color + " font-semibold text-xs px-2.5 py-1 rounded-full"}>
                              {paymentCfg.label}
                            </span>
                          </div>
                          {order.payment_status === "paid" && order.mpesa_transaction_code && (
                            <div className="flex justify-between">
                              ...
                              <span className="font-semibold text-emerald-700 text-xs">{order.mpesa_transaction_code}</span>
                            </div>
                          )}
                        </div>
