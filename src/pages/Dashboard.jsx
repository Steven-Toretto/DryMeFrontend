                  ...
                  {filteredOrders.map((order) => (
                    ...
                    >
                      ...
                      <div className="p-4 pt-5">
                        ...
                        {/* CUSTOMER CONTACT — the owner needs this to actually do the pickup */}
                        <div className="flex flex-wrap items-center gap-x-4 gap-y-1 mb-3 text-xs" style={{ color: `${TICKET_INK}CC` }}>
                          <span>{order.customer_phone || "No phone on file"}</span>
                          <span>{order.customer_location || "No location on file"}</span>
                          <div className="flex gap-3 ml-auto">
                            {order.customer_phone && (
                              <a href={`tel:${order.customer_phone}`} className="flex items-center gap-1 font-semibold hover:underline" style={{ color: "#35548C" }}>
                                <Phone size={11} /> Call
                              </a>
                            )}
                            {getMapInfo(order) && (
