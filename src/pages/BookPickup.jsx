...
//   // 🔥 Fetch services when shop changes
//   useEffect(() => {
//     if (form.shop) {
//       fetchServices(form.shop);
//     }
...
//       if (selected) {
//         setPrice(selected.price_per_kg * form.weight);
//       }
//     } else {
//       setPrice(0);
//     }
...
//     <div className="max-w-md mx-auto my-20 p-6 shadow-lg rounded-2xl ">
//       <h2 className="text-2xl font-bold mb-4">
//         Book Laundry Pickup
//       </h2>
